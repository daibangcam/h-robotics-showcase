...
void main()
{
	...
	// log time
	//ofstream process;
	//process.open("processing_time.csv");
	//process << "Frame Time, Hand Time, Finger Time, Track Time, FPS" << endl;

	// log coordinates
	ofstream coordinate;
	coordinate.open("coordinates.csv");
	coordinate << "x, y" << endl;
	...
	while (1)
	{
		...
		//process << frame_time << "," << hand_time << "," << finger_time << "," << track_time << "," << 1/track_time << endl;
