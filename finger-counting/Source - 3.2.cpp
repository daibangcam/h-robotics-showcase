...
void main()
{
	...
	// log
	ofstream myfile;
	myfile.open("processing_time.csv");
	myfile << "Frame Time, Hand Time, Finger Time, Track Time, FPS" << endl;
	...
	while (1)
	{
		...
		myfile << frame_time << "," << hand_time << "," << finger_time << "," << track_time << "," << 1/track_time << endl;
