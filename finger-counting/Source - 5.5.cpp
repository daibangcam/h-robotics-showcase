...
void main()
{
	...
	short int draw_coordinates[2000];
...
//#endif
	...
	// log draw coordinates
	ofstream draw_x2_coordinate;
	draw_x2_coordinate.open("_log_draw_x2_coordinates.csv");
	draw_x2_coordinate << "distance, angle" << endl;
			...
			if (last_num_fingers == 2 && num_fingers == 3)
			{
				...
				for (int i = 0; i < num_coordinates - 3; i += 2)
				{
					...
					if ((delta_x != 0) || (delta_y != 0))
					{
						...
						draw_x2_coordinate << draw_coordinates[num_draw_coordinates] << "," << draw_coordinates[num_draw_coordinates + 1] << endl;
						draw_x2_coordinate << draw_coordinates[num_draw_coordinates + 2] << "," << draw_coordinates[num_draw_coordinates + 3] << endl;
